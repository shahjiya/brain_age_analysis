...
```{r}
#Load excel file
template_brainage <- read_excel("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/raw/brainAGE_template.xlsx")
...
#Load thickness file
thickness_data <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/thickness_data.csv")

#Load surface area file
surfacearea_data <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/surfacearea_data.csv")
