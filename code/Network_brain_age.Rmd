...
The Netowork brain age only accepts 150 participants at a time so multiple files need to be created to only have 150 participants per file. Output files in parts and then put them through the brain age calculator. 
...
num_files <- ceiling(nrow(final_template) / participants_per_file)
...
for (i in 1:num_files) {
  ...
  end_row <- min(i*participants_per_file, nrow(final_template)) 
  
  chunked_participants <- final_template %>%
