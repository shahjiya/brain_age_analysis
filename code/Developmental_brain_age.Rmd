...
gendered_data <- female_data %>%
  mutate(across(everything(), as.character))

gendered_lh_thickness_data <- female_lh_thickness_data %>%
  mutate(across(everything(), as.character))

gendered_lh_area_data <- female_lh_area_data %>%
  mutate(across(everything(), as.character))

gendered_rh_thickness_data <- female_rh_thickness_data %>%
  mutate(across(everything(), as.character))

gendered_rh_area_data <- female_rh_area_data %>%
  mutate(across(everything(), as.character))
```
