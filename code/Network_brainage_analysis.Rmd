...
```{r}
directory <- "/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/Network_brainage_output"
...
Network_Adjusted_BrainAGE <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/Network_brainage_output/combined_Network_Adjusted_BrainAGE.csv", show_col_types = FALSE)

Network_MR_predicted_age <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/Network_brainage_output/combined_Network_MR_predicted_age.csv", show_col_types = FALSE)

Network_BrainAGE <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/Network_brainage_output/combined_Network_BrainAGE.csv", show_col_types = FALSE)

Network_Adjusted_MR_predicted_age <- read_csv("/KIMEL/tigrlab/scratch/jshah/brain_age_analysis/data/processed/Network_brainage_output/combined_Network_Adjusted_MR_predicted_age.csv", show_col_types = FALSE)
...
final_network_analysis_data <- na.omit(final_analysis_data)
...
for (dep_var in dependent_vars) {
  ...
  lm_summary <- run_lm_model(dep_var, c("prodromal_psychosis", "sex", "mean_euler_bh"), final_network_analysis_data)
